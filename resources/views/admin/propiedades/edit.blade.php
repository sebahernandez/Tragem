...
@section('content')
    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">                
                <form method="POST" action="{{ url('propiedades/update') }}" id="form-propiedades" name="form-propiedades" class="form-horizontal" 
            ...
            $.each(files, function (i, file) {
                ...
                if (file.error) {
                    ...
                    list.append('<div class="col-md-3 col-xs-12 col-sm-3" align="center" id="img-upload'+num+'" style="margin-top: 10px">'+
                                ...
                                '  value="'+nombre+'" id="r'+num+'"/> Destacada </label></div></div> ');

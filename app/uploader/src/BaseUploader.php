...
class BaseUploader
{
    ...
    public function validateFile(UploadedFile $file)
    {
        ...
        if ($maxSize && $file->getClientSize() > $maxSize) {
            throw new FileValidationException(
                $this->getErrorMessage('max_file_size', array($maxSize / 1048576)),//dividido por un byte para obtener MB
    ...
    protected function defaultConfig()
    {
        $defaults = array(
            ...
            'messages' => array(
                'max_width' => 'La imágen excede el ancho máximo de  %d pixeles.',
                'min_width' => 'La imágen requiere un ancho mínimo de %d pixeles.',
                'max_height' => 'La imágen excede el alto máximo de  %d pixeles.',
                'min_height' => 'La imágen requiere un alto mínimo de %d pixeles.',
                'max_file_size' => 'El tamaño del archivo es muy grande (limite de %dM).',
                'min_file_size' => 'El tamaño del archivo es muy pequeño.',
                'max_number_of_files' => 'Maximum number of %d files exceeded.',
                'file_not_accepted' => 'Éste tipo de archivo no es soportado.',
                'abort' => 'La operación fue cancelada.',
                'error' => 'Disculpe! Ha ocurrido un error.',
